...
```python
# 列表
client.files.list(path: str = "/", page: int = 1, page_size: int = 100, transfer_method: str = "http", hidden: bool = False) -> Dict
client.files.list_all(path: str = "/", transfer_method: str = "http", hidden: bool = False) -> List[Dict]
...
client.sftp.list(path: str = "/", page: int = 1, page_size: int = 100, hidden: bool = False) -> Dict
client.sftp.list_all(path: str = "/", hidden: bool = False) -> List[Dict]
