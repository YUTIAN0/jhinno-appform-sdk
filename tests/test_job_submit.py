...
class TestConvertWindowsPath:
    ...
    def test_drive_letter_backslash(self):
        assert convert_windows_path(r"S:\home\user\test.k", DM) == "/apps/home/user/test.k"

    def test_drive_letter_forward_slash(self):
        assert convert_windows_path("S:/home/user/test.k", DM) == "/apps/home/user/test.k"
    ...
    def test_linux_absolute_on_mapped_drive(self):
        assert convert_windows_path("/apps/home/user/test.k", DM) == "/apps/home/user/test.k"
    ...
    def test_relative_cwd_on_mapped_linux_prefix(self, tmp_path, monkeypatch):
        ...
        with patch("appform_sdk.job_submit.os.getcwd", return_value="/apps/home/user"), \
             patch("appform_sdk.job_submit.os.path.abspath", return_value="/apps/home/user/test.k"):
    ...
    def test_relative_cwd_on_mapped_windows_drive(self, monkeypatch):
        ...
        with patch("appform_sdk.job_submit.os.getcwd", return_value=r"S:\home\p-user\subdir"), \
             patch("appform_sdk.job_submit.os.path.abspath", return_value=r"S:\home\p-user\subdir\test.k"):
...
class TestIsPathMapped:
    ...
    def test_drive_letter_path(self):
        r"""On Linux abspath(S:\...) is mangled, but on Windows it stays S:\."""
        with patch("appform_sdk.job_submit.os.path.abspath", return_value=r"S:\home\user\test.k"):
...
class TestResolveRemotePath:
    def test_linux_absolute_on_mapped_drive(self):
        assert _resolve_remote_path("/apps/home/user/test.k", DM) == "/apps/home/user/test.k"
    ...
    def test_drive_letter_path(self):
        with patch("appform_sdk.job_submit.os.path.abspath", return_value=r"S:\home\user\test.k"):
            assert _resolve_remote_path(r"S:\home\user\test.k", DM) == "/apps/home/user/test.k"
...
class TestApplyPathConversion:
    ...
    def test_relative_path_cwd_on_windows_drive(self, monkeypatch):
        ...
        with patch("appform_sdk.job_submit.os.getcwd", return_value=r"S:\home\p-user\dir"), \
             patch("appform_sdk.job_submit.os.path.abspath", return_value=r"S:\home\p-user\dir\test.k"):
